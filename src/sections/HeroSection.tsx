    ...
    return (
        ...
        >
            <div className="flex max-w-full flex-col items-center justify-center sm:max-w-[60%]">
                <h1 className={cn("font-black", HeroStyles.title)}>Hi, I&apos;m Milo.</h1>
                <h2 className={cn("mb-8 font-black", HeroStyles.subtitle)}>A Web Designer and Front-End Developer.</h2>
